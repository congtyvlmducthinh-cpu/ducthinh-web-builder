global.document = {
    getElementById: function(id) { 
        ...
        if (id === 'specFilter') return { value: '', innerHTML: '' };
        if (id === 'machineFilter') return { value: '', innerHTML: '' };
        if (id === 'mainContainer') return { innerHTML: '' };
        if (id === 'controlBar') return { style: { display: '' } };
        if (id === 'priceModeBar') return { style: { display: '' } };
        return null;
    },
...
global.location = { pathname: '/kiem-tra-gia/vi.html' };
...
// Init — dữ liệu đã có sẵn trong data.js
(function() {
  applyMarket();
  switchTab("pricelist");
})();
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v4513226cdae34746b4dedf0b4dfa099e1781791509496" integrity="sha512-ZE9pZaUXND66v380QUtch/5sE9tPFh2zg45pR2PB0CVkCtOREv2AJKkSidISWkysEuQ0EH8faUU5du78bx87UQ==" data-cf-beacon='{"version":"2024.11.0","token":"1830b59f2a3f4f719ab621bbfba4c630","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous">
console.log('RENDER OUTPUT:'); console.log(renderPriceTab().substring(0, 5000));
