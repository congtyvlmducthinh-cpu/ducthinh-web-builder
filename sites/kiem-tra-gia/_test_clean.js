...
var DATA_BAGS = [{"code": "NVL-BB-PP-K55X85", "cost": 4562, "spec": "25KG", "qty": 18000, "price": 220528, "profit": 0.1}, {"code": "NVL-BB-JB-92X92X125", "cost": 127750, "spec": "Jumbo", "qty": 3000, "price": 143825, "profit": 0.1}, {"code": "NVL-BB-JB-95X95X125", "cost": 131250, "spec": "Jumbo", "qty": 3000, "price": 147675, "profit": 0.1}, {"code": "NVL-BB-25KG-52X78", "cost": 3990, "spec": "25KG", "qty": 18000, "price": 195360, "profit": 0.1}, {"code": "NVL-BB-25KG-52X75", "cost": 3800, "spec": "25KG", "qty": 18000, "price": 187000, "profit": 0.1}, {"code": "NVL-BB-25KG-52X72", "cost": 3587, "spec": "25KG", "qty": 18000, "price": 177628, "profit": 0.1}, {"code": "NVL-BB-34KG-50X78-KOTR", "cost": 3100, "spec": "34KG", "qty": 18000, "price": 156200, "profit": 0.1}, {"code": "50KG-NHUATAICHE-55X85", "cost": 2650, "spec": "50KG", "qty": 18000, "price": 78100, "profit": 0.1}, {"code": "NVL-BB-25KG-50X72-KOTR", "cost": 3000, "spec": "25KG", "qty": 18000, "price": 151800, "profit": 0.1}, {"code": "Bao jumbo cá»§a khÃ¡ch", "cost": 0, "spec": "Jumbo", "qty": 3000, "price": 3300, "profit": 0.1}, {"code": "BAO 25KG Cá»¦A KHÃCH", "cost": 0, "spec": "25KG", "qty": 18000, "price": 19800, "profit": 0.1}, {"code": "NVL-BB-JB-90X90X125-TR", "cost": 127000, "spec": "Jumbo", "qty": 3000, "price": 143000, "profit": 0.1}, {"code": "NVL-BB-JB-90X90X125-TR QUAY VÃ’NG", "cost": 43000, "spec": "Jumbo", "qty": 3000, "price": 59800, "profit": 0.3}, {"code": "NVL-BB-25KG-50X72", "cost": 3587, "spec": "25KG", "qty": 18000, "price": 177628, "profit": 0.1}];

var DATA_OTHERS = [{"code": "PALLET TÃI Sá»¬ Dá»¤NG", "cost": 70000, "price": 77000, "profit": 0.1}, {"code": "PALLET Má»šI", "cost": 120000, "price": 132000, "profit": 0.1}, {"code": "Náº¸P ÄAI", "cost": 5000, "price": 5500, "profit": 0.1}, {"code": "QUáº¤N MÃ€NG", "cost": 18000, "price": 19800, "profit": 0.1}, {"code": "PALLET TRÃNG PHá»¦", "cost": 160000, "price": 176000, "profit": 0.1}, {"code": "JUMBO Má»ž Náº®P (SLING)", "cost": 95000, "price": 104500, "profit": 0.1}, {"code": "PALLET Má»šI + Náº¸P ÄAI + QUáº¤N MÃ€NG", "cost": 143000, "price": 157300, "profit": 0.1}, {"code": "JUMBO Má»ž Náº®P (SLING) Cá»¦A KHÃCH", "cost": 35000, "price": 38500, "profit": 0.1}];
...
// 02-pricelist.js
// ====== PRICE MODE CONTROLS (GiÃ¡ bÃ¡n tab) ======
...
function renderPriceTab() {
  ...
  if (isCif && (!freightUSD || freightUSD <= 0)) {
    h += '<div class="freight-warning">âš ï¸ Cháº¿ Ä‘á»™ CIF yÃªu cáº§u nháº­p cÆ°á»›c biá»ƒn. Vui lÃ²ng nháº­p Freight USD á»Ÿ thanh cÃ´ng cá»¥ bÃªn trÃªn.</div>';
  }
  ...
  h += '<div class="summary-card"><div class="lbl">Sáº£n pháº©m</div><div class="val">' + filtered.length + '</div></div>';
  h += '<div class="summary-card"><div class="lbl">TiÃªu chuáº©n</div><div class="val">' + Object.keys(uniqueSpecs).length + '</div></div>';
  h += '<div class="summary-card"><div class="lbl">MÃ¡y</div><div class="val">' + Object.keys(uniqueMachines).length + '</div></div>';
  h += '<div class="summary-card"><div class="lbl">NgÃ y</div><div class="val" style="font-size:16px">25/06/2026</div></div>';
  h += '</div>';
  h += '<button class="btn-sm" id="mlToggleBtn" onclick="toggleMaxLoad()" style="margin:0 0 0 auto;font-size:12px;padding:4px 10px;background:var(--card);border:1px solid var(--border);border-radius:var(--radius-sm);cursor:pointer">ðŸ“‹ Hiá»‡n max táº£i</button>';
  ...
  h += '<div class="summary-card" style="padding:8px 12px;background:#fef2f2;border-color:#fecaca"><div class="lbl" style="font-size:10px">C.nháº¥t 25KG</div><div class="val" style="font-size:15px">' + fmt(max25) + '</div></div>';
  ...
  h += '<div class="summary-card" style="padding:8px 12px;background:#fefce8;border-color:#fde68a"><div class="lbl" style="font-size:10px">C.nháº¥t Jumbo</div><div class="val" style="font-size:15px">' + fmt(maxJ) + '</div></div>';
  ...
  h += '<div class="summary-card" style="padding:8px 12px;background:#fff1f2;border-color:#fecdd3"><div class="lbl" style="font-size:10px">C.nháº¥t EXW</div><div class="val" style="font-size:15px">' + fmt(maxExw) + '</div></div>';
  h += '</div>';

  // Table
  h += '<div class="table-wrap pricelist"><table><thead>';
  h += '<tr><th colspan="4">ThÃ´ng tin</th><th colspan="2" class="ml-toggle">Max táº£i</th><th colspan="2">' + (priceMode==="exw"?"GiÃ¡ bÃ¡n (EXW)":"GiÃ¡ bao gá»“m bao bÃ¬") + '</th>';
  if (!showFobCif) h += '<th colspan="2">' + (priceMode==="exw"?"EXW chÆ°a bao bÃ¬":"GiÃ¡ bÃ¡n (EXW)") + '</th>';
  h += '</tr>';
  h += '<tr><th>MÃ£</th><th>KÃ­ch thÆ°á»›c</th><th>TiÃªu chuáº©n</th><th>MÃ¡y</th><th class="ml-toggle">Max 25KG <span class="info-row">(táº¥n)</span></th><th class="ml-toggle">Max Jumbo <span class="info-row">(táº¥n)</span></th><th>' + (priceMode==="exw"?"EXW 25KG bao tiÃªu chuáº©n":"25KG") + ' <span class="info-row">(VND)</span></th><th>' + (priceMode==="exw"?"EXW jumbo bao tiÃªu chuáº©n":"Jumbo") + ' <span class="info-row">(VND)</span></th>';
  if (!showFobCif) {
    h += '<th>' + (priceMode==="exw"?"EXW chÆ°a bao bÃ¬":"EXW") + ' <span class="info-row">' + (isUsd ? '(USD)' : '(VND)') + '</span></th><th>' + (priceMode==="exw"?"Hoa há»“ng cÆ¡ báº£n":"Hoa há»“ng") + ' <span class="info-row">' + (isUsd ? '(USD)' : '(VND)') + '</span></th>';
  }
  h += '</tr></thead><tbody>';
  ...
  for (var i = 0; i < filtered.length; i++) {
    ...
    if (isFob) {
      ...
      h += '<td class="text-right">' + (p.pkg25_vnd ? (isUsd ? formatCurrency(p.pkg25_usd, true) : formatCurrency(p.pkg25_vnd, false)) : 'â€”') + '</td>';
      h += '<td class="text-right">' + (p.jumbo_vnd ? (isUsd ? formatCurrency(p.jumbo_usd, true) : formatCurrency(p.jumbo_vnd, false)) : 'â€”') + '</td>';
    }
    if (!showFobCif) {
...
function populateFilters() {
  ...
  if (sf) {
    ...
    sf.innerHTML = '<option value="">Táº¥t cáº£ tiÃªu chuáº©n</option>';
  ...
  if (mf) {
    ...
    mf.innerHTML = '<option value="">Táº¥t cáº£ mÃ¡y</option>';
...
function renderBagsTab() {
  ...
  h += '<tr><th colspan="4">ThÃ´ng tin bao bÃ¬</th><th colspan="2">GiÃ¡</th></tr>';
  h += '<tr><th>MÃ£ bao</th><th>Quy cÃ¡ch</th><th>Sá»‘ lÆ°á»£ng</th><th>GiÃ¡ vá»‘n</th><th>GiÃ¡ bÃ¡n</th><th>Lá»£i nhuáº­n</th></tr>';
  h += '</thead><tbody>';
  ...
  h += '<div class="summary-card"><div class="lbl">Tá»•ng loáº¡i bao</div><div class="val">' + DATA_BAGS.length + '</div></div>';
...
function renderOthersTab() {
  var h = '<div class="table-wrap" style="margin-top:0"><table><thead>';
  h += '<tr><th>Quy cÃ¡ch khÃ¡c</th><th>GiÃ¡ vá»‘n</th><th>GiÃ¡ bÃ¡n</th><th>Lá»£i nhuáº­n</th></tr>';
  h += '</thead><tbody>';
  ...
  h += '</tbody></table></div>';
  h += '<div class="summary-bar" style="margin-top:12px">';
  h += '<div class="summary-card"><div class="lbl">Tá»•ng quy cÃ¡ch</div><div class="val">' + DATA_OTHERS.length + '</div></div>';
  h += '</div>';
  return h;
}
...
function renderCalcTab() {
  ...
  h += '<div class="calc-section-title"><span class="badge blue">ðŸ“¦</span><span class="title-text">Chá»n sáº£n pháº©m</span></div>';
  ...
  h += '<div class="calc-form-group"><label class="calc-form-label">ðŸ”– Sáº£n pháº©m</label>';
...
function filterCalcProducts_products() {
  ...
  DATA_PRODUCTS.forEach(function(p) { if ((!m || String(p.machine) === m) && (!s || p.standard === s)) pe.innerHTML += '<option value="' + p.code + '">' + p.code + ' â€” ' + p.size + '</option>'; });
  pe.value = prevProd;
}
...
function populateCalcMaxLoad() {
  ...
  mlsel.innerHTML = '<option value="">â€” Tá»± Ä‘á»™ng (theo quy cÃ¡ch bao) â€”</option>';
  if (!pcode) return;
...
function downloadTemplate(type) {
  ...
  if (type === 0) {
    ...
    fn = "Mau_max_tai.xlsx";
    headers = ["Sáº¢N PHáº¨M","Max Loading 25KG","Max Loading Jumbo"];
  }
...
function handleManageFile(file) {
  ...
  if (!file.name.match(/.xlsx?$/i)) {
    ...
    status.textContent = "âŒ Chá»‰ há»— trá»£ file Excel (.xlsx)";
    return;
  }
  status.className = "manage-status-sm loading";
  status.textContent = "â³ Äang xá»­ lÃ½ file...";
  ...
  reader.onload = function(e) {
    try {
      ...
      var prodSheet = hasSheet(["Products", "products", "Sáº£n pháº©m", "sáº£n pháº©m", "Product", "product", "Template", "GiÃ¡ bÃ¡n tá»‘i thiá»ƒu", "giÃ¡ bÃ¡n tá»‘i thiá»ƒu", "GiÃ¡ bÃ¡n", "Gia ban", "GiÃ¡"]);
      if (prodSheet) {
        var s = XLSX.utils.sheet_to_json(wb.Sheets[prodSheet]);
        if (s.length > 0) { importProducts(s); updated++; }
      }
      
      var bagSheet = hasSheet(["Bags", "bags", "Bao bÃ¬", "bao bÃ¬", "Bao", "bao", "Bag"]);
      if (bagSheet) {
        var s = XLSX.utils.sheet_to_json(wb.Sheets[bagSheet]);
        if (s.length > 0) { DATA_BAGS = s; updated++; }
      }
      
      var otherSheet = hasSheet(["Others", "others", "Quy cÃ¡ch khÃ¡c", "Other", "other"]);
      if (otherSheet) {
        var s = XLSX.utils.sheet_to_json(wb.Sheets[otherSheet]);
        if (s.length > 0) { DATA_OTHERS = s; updated++; }
      }
      
      var mlSheet = hasSheet(["MaxLoading", "maxloading", "Max Load", "max_load", "Táº£i trá»ng", "táº£i trá»ng"]);
      if (mlSheet) {
      ...
      status.className = "manage-status-sm ok";
            saveToServer();
      status.textContent = "âœ… ÄÃ£ cáº­p nháº­t " + updated + " báº£ng dá»¯ liá»‡u!";
    } catch(err) {
      status.className = "manage-status-sm err";
      status.textContent = "âŒ Lá»—i: " + err.message;
    }
  };
  ...
  arr.forEach(function(r) {
    ...
    var code = r.code || r.Code || r.CodeSP || r.CodeSP_Standard || r["Sáº¢N PHáº¨M"] || r["SAN PHAM"] || "";
    if (!code) return;
    var obj = {};
...
function importCostFOB(arr) {
  DATA_COST_FOB = {};
  arr.forEach(function(r) {
    var load = Number(r.maxLoading || r.MaxLoading || r.load || r.Load || r.tan || r.Tan || r["Táº¥n"] || r["Max loadding"] || r["Max Loadding"]);
    if (!load) return;
    var obj = {};
...
function updateDataInfo() {
  ...
  if (!el) return;
  el.textContent = "ðŸ“Š " + DATA_PRODUCTS.length + " SP Â· " + DATA_BAGS.length + " BB Â· " + DATA_OTHERS.length + " QC";
}
...
function filterFreightRoutes() {
  ...
  if (count) count.textContent = filtered.length + " tuyáº¿n";
  if (!tbody) return;
...
function showQuotationPopup() {
  ...
  if (!data) {
    alert("Chá»n sáº£n pháº©m vÃ  tÃ­nh giÃ¡ trÆ°á»›c khi lÃªn bÃ¡o giÃ¡!");
    return;
  }
  ...
  document.getElementById("qDateSpan").textContent = "MÃ£: "+code+" | Sá»‘: "+qn+" | "+dd+"/"+mm+"/"+yy;
...
function updateQuotationPreview() {
  ...
  if (!data) {
    content.innerHTML="<p style=\"text-align:center;color:#94a3b8;font-size:13px\">Chá»n sáº£n pháº©m vÃ  tÃ­nh giÃ¡ trÆ°á»›c khi lÃªn bÃ¡o giÃ¡</p>";
    return;
  }
  ...
  var h="";
  h+="<p style=\"text-align:center;font-weight:700;font-size:14px;color:#1e293b;margin:0 0 16px\">ðŸ“„ BÃO GIÃ</p>";
  h+="<div class=\"q-row\"><strong>KhÃ¡ch hÃ ng:</strong><span>"+customer+"</span></div>";
  if (contact) h+="<div class=\"q-row\"><strong>NgÆ°á»i liÃªn há»‡:</strong><span>"+contact+"</span></div>";
  if (assigned) h+="<div class=\"q-row\"><strong>NgÆ°á»i phá»¥ trÃ¡ch:</strong><span>"+assigned+"</span></div>";
  if (custEmail) h+="<div class=\"q-row\"><strong>Email:</strong><span>"+custEmail+"</span></div>";
  h+="<div class=\"q-row\"><strong>NgÃ y:</strong><span>"+dateStr+"</span></div>";
  if (port) h+="<div class=\"q-row\"><strong>Cáº£ng Ä‘i:</strong><span>"+port+"</span></div>";
  h+="<table class=\"q-table\">";
  h+="<thead><tr><th>STT</th><th>Code</th><th>TÃªn sáº£n pháº©m</th><th>Spec</th><th>Quy cÃ¡ch bao</th><th>ÄVT</th><th>SL</th><th>GiÃ¡</th><th>Tiá»n tá»‡</th></tr></thead>";
  h+="<tbody>";
  h+="<tr><td>1</td><td>"+data.code+"</td><td>"+data.size+"</td><td style=\"font-size:11px\">"+data.spec+"</td><td>"+data.bagSpec+"</td><td>Táº¥n</td><td>"+qty+"</td><td style=\"font-weight:700\">"+totalFmt+"</td><td>"+data.cc+"</td></tr>";
  h+="</tbody></table>";
  h+="<div class=\"q-terms\">";
  h+="<div class=\"q-row\"><strong>Delivery Terms:</strong><span>"+delivery+"</span></div>";
  if (port&&(delivery==="FOB"||delivery==="CIF")) h+="<div class=\"q-row\"><strong>Cáº£ng Ä‘i:</strong><span>"+port+"</span></div>";
  h+="<div class=\"q-row\"><strong>Äiá»u kiá»‡n:</strong><span>"+data.mode+"</span></div>";
  h+="<div class=\"q-row\"><strong>Hiá»‡u lá»±c:</strong><span>"+valid+"</span></div>";
  h+="<div class=\"q-row\"><strong>Thanh toÃ¡n:</strong><span>"+payment+"</span></div>";
  if (note) h+="<div class=\"q-row\"><strong>Ghi chÃº:</strong><span>"+note+"</span></div>";
  h+="</div>";
  h+="<div class=\"q-footer\">";
  h+="- GiÃ¡ khÃ´ng bao gá»“m thuáº¿ VAT<br>";
  h+="- "+(delivery==="Táº¡i kho nhÃ  mÃ¡y Äá»©c Thá»‹nh"?"GiÃ¡ chÆ°a bao gá»“m chi phÃ­ váº­n chuyá»ƒn Ä‘áº¿n kho ngÆ°á»i mua":"GiÃ¡ Ä‘Ã£ bao gá»“m chi phÃ­ váº­n chuyá»ƒn Ä‘áº¿n kho ngÆ°á»i mua")+"<br>";
  h+="- BÃ¡o giÃ¡ nÃ y cÃ³ hiá»‡u lá»±c trong vÃ²ng "+valid+"<br>";
  h+="- Sá»‘ lÆ°á»£ng tá»‘i thiá»ƒu: 1 container 20 feet (khoáº£ng 21 táº¥n)";
  h+="</div>";
  content.innerHTML=h;
}
function getQuotationText() {
  var data=getCalcPriceData();
  if (!data) return "ChÆ°a cÃ³ dá»¯ liá»‡u sáº£n pháº©m";
  var customer=document.getElementById("qCustomer").value||"______________________";
  var contact=document.getElementById("qContact").value||"";
  var assigned=document.getElementById("qAssigned").value||"";
  var custEmail=document.getElementById("qCustEmail").value||"";
  ...
  t+="â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n";
  t+="ðŸ“„ BÃO GIÃ\n";
  t+="â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n";
  t+="KhÃ¡ch hÃ ng: "+customer+"\n";
  if (contact) t+="NgÆ°á»i liÃªn há»‡: "+contact+"\n";
  if (assigned) t+="NgÆ°á»i phá»¥ trÃ¡ch: "+assigned+"\n";
  if (custEmail) t+="Email: "+custEmail+"\n";
  t+="NgÃ y: "+dateStr+"\n";
  t+="â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n";
  t+="Sáº£n pháº©m: "+data.product+"\n";
  t+="Spec: "+data.spec+"\n";
  t+="Quy cÃ¡ch bao: "+data.bagSpec+"\n";
  t+="Sá»‘ lÆ°á»£ng: "+qty+" táº¥n\n";
  t+="Äiá»u kiá»‡n: "+data.mode+"\n";
  if (port) t+="Cáº£ng Ä‘i: "+port+"\n";
  t+="Delivery Terms: "+delivery+"\n";
  t+="â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n";
  t+="GiÃ¡ bÃ¡n: "+totalFmt+" "+data.cc+" / táº¥n\n";
  t+="â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€\n";
  t+="Hiá»‡u lá»±c: "+valid+"\n";
  t+="Thanh toÃ¡n: "+payment+"\n";
  if (note) t+="Ghi chÃº: "+note+"\n";
  t+="\n";
  t+="- GiÃ¡ khÃ´ng bao gá»“m thuáº¿ VAT\n";
  t+="- "+(delivery==="Táº¡i kho nhÃ  mÃ¡y Äá»©c Thá»‹nh"?"GiÃ¡ chÆ°a bao gá»“m chi phÃ­ váº­n chuyá»ƒn":"GiÃ¡ Ä‘Ã£ bao gá»“m chi phÃ­ váº­n chuyá»ƒn")+"\n";
  t+="- BÃ¡o giÃ¡ nÃ y cÃ³ hiá»‡u lá»±c "+valid+"\n";
  return t;
}
function copyQuotation() {
  var txt=getQuotationText();
  if (navigator.clipboard) { navigator.clipboard.writeText(txt).then(function(){alert("âœ… ÄÃ£ copy bÃ¡o giÃ¡ vÃ o clipboard");}); }
  else { prompt("Copy Ä‘oáº¡n text dÆ°á»›i Ä‘Ã¢y:",txt); }
}
function printQuotation() {
  var data=getCalcPriceData();
  if (!data) return alert("Chá»n sáº£n pháº©m vÃ  tÃ­nh giÃ¡ trÆ°á»›c!");
  var customer=document.getElementById("qCustomer").value||"______________________";
  var contact=document.getElementById("qContact").value||"";
  var assigned=document.getElementById("qAssigned").value||"";
  var custEmail=document.getElementById("qCustEmail").value||"";
  ...
  w.document.write('<!DOCTYPE html><html><head><meta charset="utf-8"><title>BÃ¡o giÃ¡ - '+data.product+'</title>');
  ...
  w.document.write('<p class="title">ðŸ“„ BÃO GIÃ</p>');
  w.document.write('<div class="row"><strong>KhÃ¡ch hÃ ng:</strong><span>'+customer+'</span></div>');
  if (contact) w.document.write('<div class="row"><strong>NgÆ°á»i liÃªn há»‡:</strong><span>'+contact+'</span></div>');
  if (assigned) w.document.write('<div class="row"><strong>NgÆ°á»i phá»¥ trÃ¡ch:</strong><span>'+assigned+'</span></div>');
  if (custEmail) w.document.write('<div class="row"><strong>Email:</strong><span>'+custEmail+'</span></div>');
  w.document.write('<div class="row"><strong>NgÃ y:</strong><span>'+dateStr+'</span></div>');
  if (port) w.document.write('<div class="row"><strong>Cáº£ng Ä‘i:</strong><span>'+port+'</span></div>');
  w.document.write('<table><thead><tr><th>STT</th><th>Code</th><th>TÃªn sáº£n pháº©m</th><th>Spec</th><th>Quy cÃ¡ch bao</th><th>ÄVT</th><th>SL</th><th>GiÃ¡</th><th>Tiá»n tá»‡</th></tr></thead><tbody>');
  w.document.write('<tr><td>1</td><td>'+data.code+'</td><td>'+data.size+'</td><td style="font-size:11px">'+data.spec+'</td><td>'+data.bagSpec+'</td><td>Táº¥n</td><td>'+qty+'</td><td><strong>'+totalFmt+'</strong></td><td>'+data.cc+'</td></tr>');
  w.document.write('</tbody></table>');
  w.document.write('<div class="row"><strong>Delivery Terms:</strong><span>'+delivery+'</span></div>');
  w.document.write('<div class="row"><strong>Äiá»u kiá»‡n:</strong><span>'+data.mode+'</span></div>');
  w.document.write('<div class="row"><strong>Hiá»‡u lá»±c:</strong><span>'+valid+'</span></div>');
  w.document.write('<div class="row"><strong>Thanh toÃ¡n:</strong><span>'+payment+'</span></div>');
  if (note) w.document.write('<div class="row"><strong>Ghi chÃº:</strong><span>'+note+'</span></div>');
  w.document.write('<div class="footer">- GiÃ¡ khÃ´ng bao gá»“m thuáº¿ VAT<br>- '+(delivery==="Táº¡i kho nhÃ  mÃ¡y Äá»©c Thá»‹nh"?"GiÃ¡ chÆ°a bao gá»“m chi phÃ­ váº­n chuyá»ƒn Ä‘áº¿n kho ngÆ°á»i mua":"GiÃ¡ Ä‘Ã£ bao gá»“m chi phÃ­ váº­n chuyá»ƒn Ä‘áº¿n kho ngÆ°á»i mua")+'<br>- BÃ¡o giÃ¡ nÃ y cÃ³ hiá»‡u lá»±c trong vÃ²ng '+valid+'<br>- Sá»‘ lÆ°á»£ng tá»‘i thiá»ƒu: 1 container 20 feet (khoáº£ng 21 táº¥n)<br><br><strong>'+COMPANY_EN+'</strong></div>');
...
// 10-market.js
/**
 * 10-market.js â€” Market/Data functions
 */
function importProducts(arr) {
  DATA_PRODUCTS = [];
  arr.forEach(function(r) {
    var obj = {};
    obj.code = r.code || r.Code || r["MÃ£ SP"] || r["Ma SP"] || r["MÃ£ sáº£n pháº©m"] || r["MÃ£"] || "";
    if (!obj.code) return;
    obj.size = r.size || r.Size || r["Cá»¡ háº¡t"] || r["Co hat"] || r["Size"] || "";
    obj.standard = r.standard || r.Standard || r["TiÃªu chuáº©n"] || r["Tieu chuan"] || r["Standard"] || "";
    obj.machine = r.machine || r.Machine || r["MÃ¡y cháº¡y"] || r["May chay"] || r["MÃ¡y"] || r["May"] || "";
    var vndFields = {
      ...
      comm_vnd: ["Hoa há»“ng (VND)","Hoa hong (VND)","Hoa há»“ng(VND)","comm_vnd","comm vnd"],
      comm_usd: ["Hoa há»“ng (USD)","Hoa hong (USD)","Hoa há»“ng(USD)","comm_usd","comm usd"],
    ...
    function readMarketField(r, obj, key, suffix) {
      var baseNames = ["EXW (VND)","EXW (USD)","Hoa há»“ng (VND)","Hoa há»“ng (USD)","25kg (VND)","25kg (USD)","Jumbo (VND)","Jumbo (USD)"];
...
// Init â€” dá»¯ liá»‡u Ä‘Ã£ cÃ³ sáºµn trong data.js
(function() {
  applyMarket();
  switchTab("pricelist");
})();
